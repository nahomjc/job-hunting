...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ...
    className={cn(
      ...
      "data-[state=closed]:animate-[fade-in_150ms_ease-in_reverse]",
      className
    )}
    {...props}
  />
  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "gap-4 border border-border bg-popover p-6 shadow-lg rounded-xl",
    ...
    >
      ...
      <DialogPrimitive.Close
        className={cn(
          ...
          "text-muted-foreground opacity-70 transition-all duration-150",
